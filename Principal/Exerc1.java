...
public class Exerc1 {
	...
	public static void main(String[] args) {
		...
		String nome = null, matéria = null, turma = null;
		Scanner lerdados = new Scanner (System.in);
		
		Pessoa1 pessoa = new Pessoa1(nome, ID);
		Alunos aluno = new Alunos (matéria, ID);
		Professor prof = new Professor (turma, ID);

		System.out.println("Antes de começar, digite a seguinte informacao");
		...
		case 1:
			...
			ID = lerdados.nextInt();
			System.out.println("Informe o numero de matérias: ");
			materia = lerdados.nextInt();
			String[] Nmateria = new String [materia];
			for(int i=0; i<materia; i++) {
					System.out.printf("Informe as matérias[%s]:",i);
